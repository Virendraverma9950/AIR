...
bot = Client("bot",
             bot_token= "6262497675:AAGut8FTPNWsEgCm6S4B_x7a7mFwKuxbIEI",
             api_id= 21408627,
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1002036693401, x)
            ...
            try:
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1002036693401)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
